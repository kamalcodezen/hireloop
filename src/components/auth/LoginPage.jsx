...
// . আসল লগইন ফরমের কোডটুকুকে আলাদা কমপোনেন্টে নেওয়া হলো যেন useSearchParams বিল্ড ক্র্যাশ না করে
    ...
    <div className="relative z-10 w-[95%] max-w-7xl mx-auto min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-center px-10 xl:px-16">
        ...
        <p className="mt-8 text-lg leading-8 text-muted-foreground max-w-xl">
          Access your dashboard, manage applications, discover new opportunities
...
// প্রধান এক্সপোর্ট কমপোনেন্ট যা পুরো ফর্মটিকে Suspense বাউন্ডারিতে সেফ রাখে
